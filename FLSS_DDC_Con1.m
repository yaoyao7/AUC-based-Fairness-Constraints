...
a=0.5;
c=1;
constraint_bound = [0.5;0.5]+kappa;
...
save('a9a_con1_seed2.mat','x','train_auc_list','train_con1_list','test_auc_list','test_con1_list')
toc