...
from loss_corr import loss_con1
...
if True:
    ...
    for k in range(T):
        ...
        loss = Loss(logits_y_pos, logits_y_neg, logits_g_pos, logits_g_neg, target_g_pos, target_g_neg, g_pos, g_neg, lamb)
    ...
    s = "corr_con1_fair="+str(para.fair_con)+"_seed="+str(SEED)+"_lr_0="+str(para.lr_0)+"_T="+str(para.T)+"_c="+str(para.c)+".csv"
    d8.to_csv(s)  